...
ROADMAP.md slices 32-43 已执行。PLAN.md 审查记录更新。`./scripts/check-release.sh` 和 `./scripts/check-root.sh --quick` 通过；CI Windows smoke 发现的脚本可执行位/rotatingwriter 文件句柄问题已修复并重新验证。
